...
# Uncomment and modify arguments in scripts below if you have any problems with data sorting
 ...
 utils/validate_data_dir.sh --no-feats data/test     # script for checking prepared data - here: for data/train directory
 utils/fix_data_dir.sh data/test
steps/make_mfcc.sh --nj $train_nj --cmd "$train_cmd" data/train exp/make_mfcc/train $mfccdir
steps/make_mfcc.sh --nj $train_nj --cmd "$train_cmd" data/test exp/make_mfcc/test $mfccdir
...
steps/decode.sh --nj $train_nj --cmd "$decode_cmd" exp/mono/graph data/test exp/mono/decode
echo
echo "===== MONO ALIGNMENT ====="
echo
